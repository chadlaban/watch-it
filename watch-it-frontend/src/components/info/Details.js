      ...
      <div className="max-w-5xl mx-auto p-6 bg-gray-100 rounded-lg shadow-md mt-8">
        <div className="flex flex-col lg:flex-row gap-10 items-center">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 italic mb-4">{data.tagline}</p>
            ...
            <div className="mt-4 grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700">{data.runtime} minutes</p>
              </div>
              <div>
                <h4 className="font-semibold text-gray-800">Vote Average:</h4>
                <p className="text-gray-700">{data.vote_average} / 10</p>
              </div>
              <div>
                <h4 className="font-semibold text-gray-800">Vote Count:</h4>
                <p className="text-gray-700">{data.vote_count}</p>
              </div>
            </div>
          </div>
        </div>
