...
export const ReviewsSkeleton = () => {
  return (
    <div
      className="animate-pulse max-w-5xl mx-auto p-6 bg-white border rounded-lg shadow-md mt-8"
      role="status"
    >
      <h3 className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-[20%] mt-4 mb-[12px]">
        {""}
      </h3>
